...
{
    public class CreateHandler<TEntity, TModel> : IRequestHandler<CreateCommand<TEntity, TModel>, TModel> where TEntity : class, new() where TModel : class, new()
    {
        ...
        public CreateHandler(IUnitOfWork<TEntity> unitOfWork, IMapperConfiguration<TEntity, TModel> mapperConfiguration)
        {
            _unitOfWork = unitOfWork;
            _mapperConfiguration = mapperConfiguration;
        }

        public async Task<TModel> Handle(CreateCommand<TEntity, TModel> request, CancellationToken cancellationToken)
        {
